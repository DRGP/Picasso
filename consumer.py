...
queue_url = 'https://sqs.us-east-1.amazonaws.com/001219492244/imageQueue'
api_url = 'http://ec2-18-206-87-119.compute-1.amazonaws.com:30072/logs/'

s = sched.scheduler(time.time, time.sleep)
def timed_receive(sc): 
    ...
    s.enter(10, 1, timed_receive, (sc,))

s.enter(10, 1, timed_receive, (s,))
s.run()